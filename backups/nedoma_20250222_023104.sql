...
--
-- Name: tag_type; Type: TYPE; Schema: public; Owner: grigorii
--
...
ALTER TYPE public.tag_type OWNER TO grigorii;
...
--
-- Name: temp_users; Type: TABLE; Schema: public; Owner: grigorii
--

CREATE TABLE public.temp_users (
    id integer NOT NULL,
    temp_id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    telegram_id bigint,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
...
ALTER TABLE public.temp_users OWNER TO grigorii;

--
-- Name: temp_users_id_seq; Type: SEQUENCE; Schema: public; Owner: grigorii
--
...
ALTER TABLE public.temp_users_id_seq OWNER TO grigorii;

--
-- Name: temp_users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: grigorii
--
...
CREATE TABLE public.user_category_preferences (
    ...
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT user_category_preferences_interest_level_check CHECK (((interest_level >= 0) AND (interest_level <= 3)))
);
...
--
-- Name: temp_users id; Type: DEFAULT; Schema: public; Owner: grigorii
--
...
62945624-2276-4aa1-aece-acfca2ff71d1	admin	$2b$10$5if/l2kPzj.tvXjwW/wjJejnmzMCnpAEXXwiOQnWuBhlP.vu1fh6m	2025-02-14 13:18:07.724501	t	ADMIN	2025-02-12 08:57:54.048948	2025-02-22 10:25:01.614757
\.
...
COPY public.tag_subcategories (id, tag_id, subcategory_id, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: temp_users; Type: TABLE DATA; Schema: public; Owner: grigorii
--

COPY public.temp_users (id, temp_id, telegram_id, created_at, last_active_at) FROM stdin;
\.
...
COPY public.user_category_preferences (id, user_id, category_id, interest_level, created_at, updated_at) FROM stdin;
\.
...
COPY public.user_tag_preferences (id, user_id, subcategory_id, tag_id, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: temp_users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: grigorii
--
...
ALTER TABLE ONLY public.tag_subcategories
    ADD CONSTRAINT tag_subcategories_pkey PRIMARY KEY (id);


--
-- Name: tag_subcategories tag_subcategories_tag_id_subcategory_id_key; Type: CONSTRAINT; Schema: public; Owner: grigorii
--

ALTER TABLE ONLY public.tag_subcategories
    ADD CONSTRAINT tag_subcategories_tag_id_subcategory_id_key UNIQUE (tag_id, subcategory_id);
...
--
-- Name: temp_users temp_users_pkey; Type: CONSTRAINT; Schema: public; Owner: grigorii
--
...
--
-- Name: temp_users temp_users_telegram_id_key; Type: CONSTRAINT; Schema: public; Owner: grigorii
--

ALTER TABLE ONLY public.temp_users
    ADD CONSTRAINT temp_users_telegram_id_key UNIQUE (telegram_id);


--
-- Name: temp_users temp_users_temp_id_key; Type: CONSTRAINT; Schema: public; Owner: grigorii
--

ALTER TABLE ONLY public.temp_users
    ADD CONSTRAINT temp_users_temp_id_key UNIQUE (temp_id);
...
--
-- Name: user_category_preferences user_category_preferences_user_id_category_id_key; Type: CONSTRAINT; Schema: public; Owner: grigorii
--
...
--
-- Name: user_tag_preferences user_tag_preferences_user_id_subcategory_id_tag_id_key; Type: CONSTRAINT; Schema: public; Owner: grigorii
--

ALTER TABLE ONLY public.user_tag_preferences
    ADD CONSTRAINT user_tag_preferences_user_id_subcategory_id_tag_id_key UNIQUE (user_id, subcategory_id, tag_id);
...
--
-- Name: idx_tag_subcategories_tag_id; Type: INDEX; Schema: public; Owner: grigorii
--

CREATE INDEX idx_tag_subcategories_tag_id ON public.tag_subcategories USING btree (tag_id);
...
--
-- Name: idx_temp_users_telegram_id; Type: INDEX; Schema: public; Owner: grigorii
--

CREATE INDEX idx_temp_users_telegram_id ON public.temp_users USING btree (telegram_id);


--
-- Name: idx_temp_users_temp_id; Type: INDEX; Schema: public; Owner: grigorii
--

CREATE INDEX idx_temp_users_temp_id ON public.temp_users USING btree (temp_id);


--
-- Name: idx_user_category_preferences_category_id; Type: INDEX; Schema: public; Owner: grigorii
--

CREATE INDEX idx_user_category_preferences_category_id ON public.user_category_preferences USING btree (category_id);


--
-- Name: idx_user_category_preferences_user_id; Type: INDEX; Schema: public; Owner: grigorii
--
...
--
-- Name: idx_user_tag_preferences_subcategory_id; Type: INDEX; Schema: public; Owner: grigorii
--

CREATE INDEX idx_user_tag_preferences_subcategory_id ON public.user_tag_preferences USING btree (subcategory_id);
...
--
-- Name: tag_subcategories set_tag_subcategories_updated_at; Type: TRIGGER; Schema: public; Owner: grigorii
--

CREATE TRIGGER set_tag_subcategories_updated_at BEFORE UPDATE ON public.tag_subcategories FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: user_tag_preferences set_user_tag_preferences_updated_at; Type: TRIGGER; Schema: public; Owner: grigorii
--

CREATE TRIGGER set_user_tag_preferences_updated_at BEFORE UPDATE ON public.user_tag_preferences FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: tag_subcategories sync_tag_subcategories_trigger; Type: TRIGGER; Schema: public; Owner: grigorii
--

CREATE TRIGGER sync_tag_subcategories_trigger AFTER INSERT OR DELETE OR UPDATE ON public.tag_subcategories FOR EACH ROW EXECUTE FUNCTION public.sync_tag_subcategories();
...
--
-- Name: temp_users update_temp_users_last_active; Type: TRIGGER; Schema: public; Owner: grigorii
--

CREATE TRIGGER update_temp_users_last_active BEFORE UPDATE ON public.temp_users FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: user_category_preferences user_category_preferences_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: grigorii
--
...
--
-- Name: user_tag_preferences user_tag_preferences_subcategory_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: grigorii
--

ALTER TABLE ONLY public.user_tag_preferences
    ADD CONSTRAINT user_tag_preferences_subcategory_id_fkey FOREIGN KEY (subcategory_id) REFERENCES public.subcategories(id) ON DELETE CASCADE;
